 ...
 */
	public function add($activity_id) {
		...
		if ($this->request->is('post')) {
			...
			//uploading the file
			if(move_uploaded_file($_FILES['fileField']['tmp_name'],"../webroot/img/activity_images/$file_name")){
				$this->request->data['ActivityImage']['image_file']=$file_name;//filename to use for submitted file
				
				if (copy("../webroot/img/activity_images/$file_name","../webroot/img/imagecache/activity_images/$file_name")) {
					$image ="../webroot/img/imagecache/activity_images/$file_name"; 
					...
					if ($this->ActivityImage->save($this->request->data)) {
						...
						if(file_exists("../webroot/img/activity_images/$file_name")){
							@unlink("../webroot/img/activity_images/$file_name");
						}
