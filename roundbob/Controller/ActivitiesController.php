 ...
 */
	public function add($destination_id) {
		...
		if ($this->request->is('post')) {
			...
			//uploading the file
			if(move_uploaded_file($_FILES['fileField']['tmp_name'],"../webroot/img/activities/$file_name")){
				$this->request->data['Activity']['cover_img']=$file_name;//filename to use for submitted file
				
				if (copy("../webroot/img/activities/$file_name","../webroot/img/imagecache/activities/$file_name")) {
					$image ="../webroot/img/imagecache/activities/$file_name"; 
					...
					if ($this->Activity->save($this->request->data)) {
						...
						if(file_exists("../webroot/img/activities/$file_name")){
							@unlink("../webroot/img/activities/$file_name");
						}
