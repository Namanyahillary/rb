 ...
 */
	public function add() {
		if ($this->request->is('post')) {
			...
			//uploading the file
			if(move_uploaded_file($_FILES['fileField']['tmp_name'],"../webroot/img/countries/$file_name")){
				$this->request->data['Country']['image_file']=$file_name;//filename to use for submitted file
				
				if (copy("../webroot/img/countries/$file_name","../webroot/img/imagecache/countries/$file_name")) {
					$image ="../webroot/img/imagecache/countries/$file_name"; 
					...
					if ($this->Country->save($this->request->data)) {
						...
						if(file_exists("../webroot/img/countries/$file_name")){
							@unlink("../webroot/img/countries/$file_name");
						}
		...
		if ($this->request->is('post') || $this->request->is('put')) {
			...
			if(isset($_FILES['fileField']['name']) and !empty($_FILES['fileField']['name'])){//getting the file extension and testing it
				...
				if(!$FileExtensionAllowed){
					...
					if(file_exists("../webroot/img/countries/$previous_profile_image")){
						if($this->request->data['Country']['image_file']!='default.png')
							@unlink("../webroot/img/countries/$previous_profile_image");
					}
					
					if(file_exists("../webroot/img/imagecache/countries/$previous_profile_image")){
							@unlink("../webroot/img/imagecache/countries/$previous_profile_image");
					}
