									...
									<ul class="cards">										
										<li>											
											<p class="info-text">
													...
													<span style="float:right;" class="btn btn-small" title="Edit"><i class="icon icon-edit"></i></span>
													<hr/>
													<table>
														<tr>
														...
														<tr>
															...
															<td><a class="no-ajax" href="http://www.facebook.com/namanyahillary1" target="_blank">namanyahillary1</a></td>
														</tr>
													</table>													
											</p>
										</li>
